...
namespace NBSTimeReporting.Migrations
{
    ...
    [Migration("20200323074111_NetelloABInvoicesAddd")]
    partial class NetelloABInvoicesAddd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBSTimeReporting.NBSInventory.Models.DataModels.AssetStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NBSTimeReporting.NBSInventory.Models.DataModels.NBSAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NBSAssetName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NBSAssetNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NBSTimeReporting.NBSInventory.Models.DataModels.NBSAsset", b =>
                {
                    ...
                    b.HasOne("NBSTimeReporting.NBSInventory.Models.DataModels.AssetStatus", "AssetStatus")
                        .WithMany()
                    ...
                    b.HasOne("NBSTimeReporting.Models.DataModels.Company", "Owner")
                        .WithMany()
                        .HasForeignKey("CompanyId");
