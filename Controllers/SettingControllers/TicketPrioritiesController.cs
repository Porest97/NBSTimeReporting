...
namespace NBSTimeReporting.Controllers.SettingControllers
{
    public class TicketPrioritiesController : Controller
    {
        ...
        // GET: ListTicketPriorities
        public IActionResult ListTicketPriorities()
        {
            var settingsViewModel = new SettingsViewModel()
            {
                TicketPriorities = _context.TicketPriority.ToList()
            };
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketPriorityName")] TicketPriority ticketPriority)
        {
            if (ModelState.IsValid)
            {
                _context.Add(ticketPriority);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(ListTicketPriorities));
            }
            return View(ticketPriority);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketPriorityName")] TicketPriority ticketPriority)
        {
