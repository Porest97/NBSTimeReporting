...
namespace NBSTimeReporting.Data.Migrations
{
    ...
    [Migration("20191102111609_peoplecompaniesimplemented")]
    partial class peoplecompaniesimplemented
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBSTimeReporting.Models.SettingModels.ComapnyRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ComapnyRole");
                });

            modelBuilder.Entity("NBSTimeReporting.Models.SettingModels.ComapnyStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ComapnyStatus");
                });

            modelBuilder.Entity("NBSTimeReporting.Models.SettingModels.ComapnyType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NBSTimeReporting.Models.DataModels.Company", b =>
                {
                    b.HasOne("NBSTimeReporting.Models.SettingModels.ComapnyRole", "CompanyRole")
                        .WithMany()
                        .HasForeignKey("CompanyRoleId");

                    b.HasOne("NBSTimeReporting.Models.SettingModels.ComapnyStatus", "CompanyStatus")
                        .WithMany()
                        .HasForeignKey("CompanyStatusId");

                    b.HasOne("NBSTimeReporting.Models.SettingModels.ComapnyType", "CompanyType")
                        .WithMany()
